...
import me.jcala.xmarket.server.admin.profile.SchoolInitData;
import me.jcala.xmarket.server.admin.profile.SysColName;
import me.jcala.xmarket.server.admin.profile.TradeTagsInitData;
...
public class InitServiceImpl implements InitService{
    ...
    private boolean needInit() {//判断是否需要初始化操作
        return systemRepository.count() < 3;//如果sys的条数小于2，则需要进行初始化操作
    }
